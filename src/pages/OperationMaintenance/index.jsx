...
const OperationMaintenance = () => {
    ...
    return (
        <PrincipalContainer>
            ...
            <H3><span style={{ color: "#EFA21F" }}>Our Services <MdKeyboardArrowRight style={{ height: "15px" }} /></span>Operations and Maintenance consultancy</H3>
            <Container2>
                <LeftSection>
                    <TitreH2>Operations and Maintenance consultancy</TitreH2>
                    <Text>
                    ...
                    <DivStyle>
                        <CircleButton></CircleButton>
                        <PgH>Supervision and asessment</PgH>
                    </DivStyle>
                    <DivStyle>
                        <CircleButton></CircleButton>
                        <PgH>Maintenance projects</PgH>
                    </DivStyle>
                    <Img src={gra} alt="" />
                </LeftSection>
